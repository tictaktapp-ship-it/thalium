...
old = "    } else if (scorerPayload.gate_decision === 'pass' || scorerPayload.gate_decision === 'pass_with_warning') {\n      verdict = 'approved';\n      reasoning = scorerPayload.gate_decision === 'pass_with_warning' ? 'Approved with warnings from Devil' : 'Confidence score meets threshold';\n    } else {\n      verdict = 'rejected';\n      reasoning = 'Confidence score below threshold';\n    }"

new = "    } else if (scorerPayload.gate_decision === 'pass' || (scorerPayload.gate_decision === 'pass_with_warning' && scorerPayload.confidence_score >= threshold)) {\n      verdict = 'approved';\n      reasoning = scorerPayload.gate_decision === 'pass_with_warning' ? 'Approved with warnings from Devil' : 'Confidence score meets threshold';\n    } else {\n      verdict = 'rejected';\n      reasoning = 'Confidence score below threshold';\n    }"
